...
vehicle_classname_tactical = "I_G_Offroad_01_armed_F";
 ...
 {[[[vehicle_position,vehicle_classname_transport,east], "mission_setup\spawnVehicle.sqf"],"BIS_fnc_execVM",true,true] spawn BIS_fnc_MP;  }, _Args, 1, false, true, "","_this == _target"];

if (RESTRICTED_VEHICLES) exitWith {};

 createVehicleTactical = opfor_teamlead addAction["<t color=""#93E352"">" + "Spawn Tactical",
 {[[[vehicle_position,vehicle_classname_tactical,east], "mission_setup\spawnVehicle.sqf"],"BIS_fnc_execVM",true,true] spawn BIS_fnc_MP;  }, _Args, 1, false, true, "","_this == _target"];