...
_boatsLeft = _box getVariable ["otf_buyables_boatsInBox",0];
if (_boatsLeft < 1) exitWith {};

_boatType = _box getVariable ["otf_buyables_boatType",""];
if (_boatType == "") exitWith {};

_box setVariable ["otf_buyables_boatsInBox",_boatsLeft-1,true];
