...
xcopy /y /e /c "./TvT_OnTheFly.Desert_E" "./TvT_OnTheFly%var%.clafghan\"
del "./TvT_OnTheFly%var%.clafghan\.*"
del "./TvT_OnTheFly%var%.clafghan\OTFport.bat"

xcopy /y /e /c "./TvT_OnTheFly.Desert_E" "./TvT_OnTheFly%var%.fata\"
del "./TvT_OnTheFly%var%.fata\.*"
del "./TvT_OnTheFly%var%.fata\OTFport.bat"

xcopy /y /e /c "./TvT_OnTheFly.Desert_E" "./TvT_OnTheFly%var%.FDF_Isle1_a\"
...
xcopy /y /e /c "./TvT_OnTheFly.Desert_E" "./TvT_OnTheFly%var%.saru\"
del "./TvT_OnTheFly%var%.saru\.*"
del "./TvT_OnTheFly%var%.saru\OTFport.bat"

xcopy /y /e /c "./TvT_OnTheFly.Desert_E" "./TvT_OnTheFly%var%.Shapur_BAF\"
...
xcopy /y /e /c "./TvT_OnTheFly.Desert_E" "./TvT_OnTheFly%var%.Thirsk\"
...
xcopy /y /e /c "./TvT_OnTheFly.Desert_E" "./TvT_OnTheFly%var%.xcam_prototype\"
