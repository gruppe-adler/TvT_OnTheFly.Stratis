...
_caller setVariable ["otf_selectedWeaponOnAnimation", currentWeapon _caller];
...
if (vehicle _caller == _caller && {_callerAnim != ""}) then {
    ...
    if (stance _caller == "STAND") then {
        _caller setVariable ["otf_prevAnimCaller", "amovpknlmstpsraswrfldnon"];
    } else {
        _caller setVariable ["otf_prevAnimCaller", animationState _caller];
    };
