  			  ...
  			  case 3:{
                 		   _overcast_num = (random 1);
                                   ...
                                   If(_overcast_num >= 0.7)then{
                                                                 ...
                                                                 switch(true)do
                                                                 {
                                                                   case (_rain_num <=  0.3):{_rain_num = 0;};
    								   case (_rain_num > 0.3):{_fog_num = (random 1);};
                                                                 };
                                                                   If(_fog_num > 0)then{
                                                    					 switch(true)do
                                                     					 {
                                                       					   case (_rain_num >= 0.5 && _fog_num > 0.2):{_fog_num = 0.1;};
                                                         				   case (_rain_num < 0.5 && _fog_num > 0.7):{_fog_num = 0.7;};
                                                        				   case (_rain_num < 0.5 && _fog_num < 0.3):{_fog_num = 0.3;};
                                                      				         };
                                                 					};
                       ...
                       If(_first_start)then{[_overcast_num,_rain_num,_fog_num,_wind_num,_wind_dir] spawn ga_jip_weather;}; 
                       ...
                       _first_start = false;
                       If(_wind_num > 0)then{setWind [(_wind_num * 10),(_wind_num * 10) , true];
